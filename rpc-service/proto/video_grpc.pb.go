...
const (
	VideoService_GetFeedList_FullMethodName = "/douyin.core.VideoService/GetFeedList"
)
...
func (c *videoServiceClient) GetFeedList(ctx context.Context, in *DouyinFeedRequest, opts ...grpc.CallOption) (*DouyinFeedResponse, error) {
...
func (UnimplementedVideoServiceServer) GetFeedList(context.Context, *DouyinFeedRequest) (*DouyinFeedResponse, error) {
...
func _VideoService_GetFeedList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoServiceServer).GetFeedList(ctx, req.(*DouyinFeedRequest))
	}
